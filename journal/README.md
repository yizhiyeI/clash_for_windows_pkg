...
，Web2网络和Web3的初期迭代都没能提供有利于弱势者的公平、自由的赛场。那么，符合罗尔斯标准的互联网应该是什么样子？一些通用的反向原则成为关注的焦点：
...
eb3符合罗尔斯正义原则的第一步，Web3生态系统的参与者和建设者必须努力争取民主的治理体系，让所有成员都能发声，而不是只有被选中的一小部分能发声。每个人都能在自己参与的系统中拥有平等的公民权。
...
* 另一种运用Web3的方式是利用数字信息改进现实世界里的产品。具体如下：关于某产品的信息在区块链上以智能合约的形式记录，智能合约是一种会根据事先制定的规则自动执行合法的相关事件或行动的事务协议记录的数据。可记录的数据包括产品产地、供应、生产和设计相关信息，一旦记录在区块链上就无法再更改。由此这件实物便可成为收藏品，具有唯一性和真实性。品牌可借此防止伪造，且可从二手销售中获利——以往很难实现这一点。

* 例如NBA的Top Shot商店，将球赛中精彩瞬间的视频片段——比如勇士队球星斯蒂芬·库里（Steph Curry）一记关键的三分球、湖人队勒布朗·詹姆斯（LeBron James）的传奇灌篮——作为可收藏的NFT版集换式卡片出售。这种虚拟集换式卡片是由区块链公司Dapper Labs在2020年与NBA及其球员联盟合作打造，不仅有精彩片段，还有相应球队的艺术作品、比赛和球员的数据、片段中的动作描述、专有序列号以及其他详细信息。

* 还有一些公司以各种不同的方式尝试开发混合产品。娱乐公司Secret Level与影视作品创作者合作，推出影视剧名场面的NFT，粉丝可以通过区块链购买、收集和交易。服装公司Anybodies有一个 NFT系列，拥有者可出售、分享和兑换限定版卫衣。奢侈品品牌蔻驰（Coach）在2021年圣诞季推出NFT系列，为购买者提供无法从其他渠道获取的独特产品。还可以像阿迪达斯那样，在区块链上记录参与虚拟或现实活动（如时装秀、产品发布会等）的情况，为参与者提供新产品和促销的优先权、其他活动的独家邀请以及个人造型服务。


* 品牌通过混合方式获得的益处有两方面：一是关于产品起源的可验证信息，二是社区构建。弊端则包括产出代币和在区块链上记录信息造成的能源和环境影响。据Business Insider报道，美国的比特币挖矿，即通过解数学题验证加密货币交易、产生新比特币的过程，预计会造成400亿磅碳排放。

另外，为了制造和管理这些产品，你还需要精通加密货币和区块链的人才，需要与营销、生产、推销和技术等部门通力合作，建立成功的混合模式，还需要一流的客户关系管理，在区块链上记录客户的行动并提供奖励。


# 分散的所有权

分散的所有权是一种新的品牌治理范式。运用这项策略的公司不是把一件产品卖给一个客户，而是多个客户通过区块链分享所有权。我不知道哪些传统品牌现在用了这种方法，但数字先行的公司已经在行动。随着技术演进、实验继续进行，所有营销者都应当了解分散所有权的原理，因为分散所有权有潜力改变客户社群的管理方式，以及创造和分享产品价值的方式。

* 例如分散所有权平台Otis，用户在上面买卖和交换经过证监会证券化的收藏品所有权，如艺术品、漫画、珠宝首饰和时尚服饰，打造替代性的资产组合。比方说，如果消费者想投资迈克尔·乔丹1985年灌篮震坏篮板时穿过的运动鞋，可以从Otis或其他类似平台购买这双鞋的一小部分份额，随后消费者可以出售份额获得回报，也可能因为所有者集体决定出售这双运动鞋获得分成。

* 传统品牌如何应用这种治理范式，可以参考几个场景：

* 第一个场景是拼团购物，提供两种商品售价，一种单独购买的价格，另一种是拼团价格。选择后者的购买者会进入一个群体，争取更低的价格和折扣。拼团适合大众品牌，中国的拼多多已经在用这种方法。

* 第二个场景，中档和高端品牌可以鼓励团购，借此获得关于客户需求的实时信息。实时信息基于个人购买习惯和浏览历史，但也综合了团购群体中每一个人的购买习惯和浏览历史。掌握该信息的品牌可以与制造商协商更有利的价格。如此一来，消费者能以更实惠的价格购买产品，公司库存积压（以及品牌贬值）的风险也会降低。

* 第三个场景，奢侈品牌可以让购买者分享昂贵商品的所有权，如手包或珠宝，轮流使用或像投资一样在之后出售获得利润。

* 大规模的分散所有权平台，可能会像自称“无领导者媒体社区生活方式品牌”的平台Friends with Benefits（FWB）一样，成员拥有不同级别的权限和权力，取决于在这个共有平台上获得或购买了多少代币。FWB成员福利，从FWB订阅通信、FWBDiscord频道到线下活动入场券，全部是为了加强联系、建立项目团队或寻求合作投资。FWB完全由用户领导，具备各种功能——既是音乐平台，又是初创企业孵化器，还是加密货币投资者的集会场所。付费会员就平台的购买和投资达成共识，所有行动都记录在以太坊区块链上。

* 分散所有权会让品牌获益，因为能凭借制造和产权获得回报，而消费者也能得到实际回报和部分所有权。随着市场活动增加，代币或产品的价值提升，又会吸引更多人参与，出现更多活动，形成良性循环。

尽管如此，但在需求很低或没有的时候，产品或代币价值与市场活动之间就不会出现积极反馈循环。品牌提供去中心化所有权要面临的另一个风险是难以控制。成功的去中心化平台在很大程度上依然停留在提案阶段，尚未成为现实。

所有这些Web3方法背后的技术尚在初期阶段，但随着品牌更好地了解相关的机会和挑战，改善方法，初期的实验就能发展为战略投入实行。


有新的平台，元宇宙时代新的匹配供给和需求的平台，这逻辑大家都比较了解，包括各种NFT的平台。
...
过去30年，互联网技术不断发展，我们与网络的互动方式也随之发展。虽然已经发生了很大的变化，但在线社区的三个关键时代为：
...
- 自己要练内功，高内聚，一体化，持续迭代自己的系统；给别人要传授招式，低耦合，能传一招是一招，吸收效果最佳。

- 做短视频，可以把素材和选题分为完全异步的过程：平时多积累素材库，但不发；什么时候发？等出现相关的热点话题，从热点出发，带出自己的内容。爆款概率极大。

- 竞争策略，让自己具有特殊性，让上下游标准化。不仅适用于商业，也可反观自己——比如应试教育就是一条标准化的道路。
